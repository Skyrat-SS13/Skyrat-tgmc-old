...
readonly BASE_PULL_URL="https://api.github.com/repos/tgstation/TerraGov-Marine-Corps/pulls"
...
if ! git remote | grep upstream > /dev/null; then
   git remote add upstream https://github.com/tgstation/TerraGov-Marine-Corps.git
fi
